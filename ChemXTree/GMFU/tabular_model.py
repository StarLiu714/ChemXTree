...
from .model.framework import TablFramework
from .tabular_data_modules import TabularDatamodule
from .utils import get_logger, getattr_nested, pl_load
...
class TabularModel:
    ...
    def load_model(cls, dir: str, map_location=None, strict=True):
        ...
        num_tasks = config.num_tasks  # ensure 'config' object including 'num_tasks' attribute
        n_heads = config.n_heads  # ensure 'config' object including 'n_heads' attribute
    ...
    def prepare_model(
        ...
        Returns:
            TablFramework: The prepared model
        ...
        self.config.num_tasks = self.inferred_config.num_tasks
        self.config.n_heads = self.inferred_config.n_heads
        self.config.residual_scale = self.inferred_config.residual_scale
