...
from ChemXTree.GMFU.configuration import InferredConfig
from ChemXTree.GMFU.utils import get_logger
from ChemXTree.GMFU.tabular_data_modules import TabularDataset
...
class TabularDatamodule(pl.LightningDataModule):
    ...
    def _transform_continuous_columns(self, data: pd.DataFrame, stage: str) -> pd.DataFrame:
        if stage == "fit":
            ...
            # TODO not yet implement quantile noise
